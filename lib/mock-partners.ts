...
// Data parsed from partner_dataset_final.xlsx
const excelParsedPartners: Partner[] = [
  {
    id: "p1",
    name: "Alex Rodriguez",
...
// Export the parsed data as mockPartners
export const mockPartners: Partner[] = excelParsedPartners.map(partner => ({
  ...partner,
  // Recalculate novaScore based on the current mockReviews if needed,
  // or use the one from the Excel if it's considered the source of truth.
  // For now, we'll use the novaScore directly from the Excel data.
  // If you want to recalculate based on mockReviews, uncomment the line below:
  // novaScore: calculateNovaScore(partner, mockReviews),
}));