...
const NovaPage = () => {
  ...
  useEffect(() => {
    ...
    if (storedPartners.length === 0) {
      currentDataStore.initializeWithMockData(mockPartners, [], mockFairnessMetrics)
    }
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold text-foreground">
                  {partners.length > 0 ? Math.round(partners.reduce((sum, p) => sum + p.novaScore, 0) / partners.length) : 0}
                </div>
                    ...
                    <div className="flex items-center gap-2">
                      <div className="w-24 h-2 bg-muted rounded-full overflow-hidden">
                        <div
                          ...
                          style={{ width: `${partners.length > 0 ? (scoreData.excellent / partners.length) * 100 : 0}%` }}
                        ></div>
                      </div>
                    ...
                    <div className="flex items-center gap-2">
                      <div className="w-24 h-2 bg-muted rounded-full overflow-hidden">
                        <div
                          ...
                          style={{ width: `${partners.length > 0 ? (scoreData.fair / partners.length) * 100 : 0}%` }}
                        ></div>
                      </div>
